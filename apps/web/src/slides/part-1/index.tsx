  ...
  return (
    <Stack>
      ...
      <h2 className="pb-4 font-grand-casino text-4xl font-bold text-white">
        ...
        <div className="grid w-full grid-cols-2 gap-4">
          <div className="flex flex-col items-center gap-0 col-span-1">
      ...
      <h2 className="pb-4 font-grand-casino text-4xl font-bold text-white">
          ...
          <div className="flex flex-col items-center gap-0 col-span-1 w-full">
            <a href="https://www.bcb.gov.br/conteudo/relatorioinflacao/EstudosEspeciais/EE119_Analise_tecnica_sobre_o_mercado_de_apostas_online_no_Brasil_e_o_perfil_dos_apostadores.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="w-2/3 rounded-lg border mx-auto overflow-hidden"
            >
            <img
